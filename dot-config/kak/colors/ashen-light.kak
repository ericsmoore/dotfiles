...
declare-option str text "rgb:1f1f1f"

declare-option str red_flame "rgb:d63a3a"
declare-option str red_glowing "rgb:b23535"
declare-option str red_ember "rgb:8f2a2a"

declare-option str orange_glow "rgb:cb5f28"
declare-option str orange_blaze "rgb:a94d20"
declare-option str orange_muted "rgb:b87350"
declare-option str orange_smolder "rgb:c6792e"
declare-option str orange_golden "rgb:d49215"

declare-option str golden_muted "rgb:8a6a10"
declare-option str brown "rgb:6f3c23"
declare-option str brown_dark "rgb:4a2a1d"
declare-option str brown_darker "rgb:3b1d14"

declare-option str blue "rgb:285c5c"

declare-option str background "rgb:d9d9d9"
...
declare-option str g_7andahalf "rgb:bfbfbf"
...
set-face global PrimarySelection      ",%opt{g_7}+g"
set-face global SecondarySelection    ",%opt{g_7andahalf}+g"
...
set-face global LineNumberCursor   "%opt{g_4},%opt{g_8}"
